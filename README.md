...
Готовый установочный образ: [`dist/Video-Editor-3.9.1-arm64.dmg`](dist/Video-Editor-3.9.1-arm64.dmg).
...
1. Скачайте и откройте [`Video-Editor-3.9.1-arm64.dmg`](dist/Video-Editor-3.9.1-arm64.dmg).
...
Текущая версия приложения: **3.9.1** (build 20).
