...
Готовая сборка: [`dist/Video-Editor-3.5-arm64.zip`](dist/Video-Editor-3.5-arm64.zip).
...
| --- | --- | --- |
| Сжатие SDR | Любой видеофайл, который распознаёт FFmpeg | `.mp4`: H.264, 8-битный SDR, AAC |
| Сжатие HDR | HDR/10-битное видео | `.mp4`: HEVC Main 10, HLG/PQ HDR, AAC |
| HDR → SDR | HDR/10-битное видео | `.mp4`: H.264, 8-битный SDR BT.709, AAC |
...
| Склейка | Два или более поддерживаемых видеофайла | `.mp4`: H.264 или HEVC согласно выбранному профилю, AAC |
...
1. Скачайте [`Video-Editor-3.5-arm64.zip`](dist/Video-Editor-3.5-arm64.zip).
2. Распакуйте архив.
...
Текущая версия приложения: **3.5** (build 8).
