...
Готовый установочный образ: [`dist/Video-Editor-3.6.3-arm64.dmg`](dist/Video-Editor-3.6.3-arm64.dmg).
...
1. Скачайте и откройте [`Video-Editor-3.6.3-arm64.dmg`](dist/Video-Editor-3.6.3-arm64.dmg).
...
7. автоматически создаёт и проверяет установочный образ `dist/Video-Editor-<версия>-arm64.dmg` с ярлыком папки `Applications`.
...
├── Info.plist
└── build_app.sh                # сборка arm64-приложения и DMG
