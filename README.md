...
Во время склейки приложение показывает количество и суммарный размер всех исходников, объём уже созданного результата и прогноз окончательного размера. После завершения суммарный размер исходников сравнивается с фактическим размером готового файла.
...
Текущая версия приложения: **3.6.3** (build 12).
