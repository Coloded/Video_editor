...
Готовый установочный образ: [`dist/Video-Editor-3.6.2-arm64.dmg`](dist/Video-Editor-3.6.2-arm64.dmg).
...
1. Скачайте и откройте [`Video-Editor-3.6.2-arm64.dmg`](dist/Video-Editor-3.6.2-arm64.dmg).
...
Текущая версия приложения: **3.6.2** (build 11).
