...
Готовая сборка: [`dist/Video-Editor-3.6.1-arm64.zip`](dist/Video-Editor-3.6.1-arm64.zip).
...
1. Скачайте [`Video-Editor-3.6.1-arm64.zip`](dist/Video-Editor-3.6.1-arm64.zip).
2. Распакуйте архив.
...
Текущая версия приложения: **3.6.1** (build 10).
